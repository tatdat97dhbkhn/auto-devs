        ...
        <div className='flex items-center gap-2'>
          <div className='max-w-xs flex-1'>
            <div className='relative'>
              ...
              <Input
                placeholder='Tìm kiếm lần thực thi...'
                value={searchTerm}
          ...
          >
            ...
            <SelectContent>
              <SelectItem value='started_at-desc'>Mới nhất trước</SelectItem>
              <SelectItem value='started_at-asc'>Cũ nhất trước</SelectItem>
              <SelectItem value='progress-desc'>Tiến độ ↓</SelectItem>
              <SelectItem value='progress-asc'>Tiến độ ↑</SelectItem>
          ...
          <CardContent className='p-4'>
            <div className='flex items-center gap-2 text-red-800'>
              ...
              <span className='font-medium'>
                Không thể tải các lần thực thi
              </span>
            </div>
  ...
  return (
    <Card className='w-full'>
      <CardContent className='flex flex-col items-center justify-center py-8'>
        ...
        <h3 className='mb-2 text-lg font-medium'>Chưa có lần thực thi nào</h3>
        <p className='max-w-md text-center text-sm text-gray-500'>
          Công việc này chưa có lần thực thi. Lần thực thi sẽ hiển thị tại đây
          sau khi tiến trình AI tạo ra.
        </p>
      </CardContent>
    </Card>
  )
